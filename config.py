...
MT5_MAGIC = _env_int("TRADING_MT5_MAGIC", 234000)
...
TECHNICAL_MODULES_ENABLED = _env_bool("TRADING_TECHNICAL_MODULES_ENABLED", True)
STRATEGY_C_ENABLED = _env_bool("TRADING_STRATEGY_C_ENABLED", True)
STRATEGY_D_ENABLED = _env_bool("TRADING_STRATEGY_D_ENABLED", True)
STRATEGY_E_ENABLED = _env_bool("TRADING_STRATEGY_E_ENABLED", True)
STRATEGY_F_ENABLED = _env_bool("TRADING_STRATEGY_F_ENABLED", True)
STRATEGY_G_ENABLED = _env_bool("TRADING_STRATEGY_G_ENABLED", True)
STRATEGY_H_ENABLED = _env_bool("TRADING_STRATEGY_H_ENABLED", True)
STRATEGY_I_ENABLED = _env_bool("TRADING_STRATEGY_I_ENABLED", True)
STRATEGY_J_ENABLED = _env_bool("TRADING_STRATEGY_J_ENABLED", True)
STRATEGY_K_ENABLED = _env_bool("TRADING_STRATEGY_K_ENABLED", True)
STRATEGY_L_ENABLED = _env_bool("TRADING_STRATEGY_L_ENABLED", True)
STRATEGY_SOLO_RISK_MULTIPLIER = _env_float("TRADING_STRATEGY_SOLO_RISK_MULTIPLIER", 0.50)
TECHNICAL_MIN_CONFIRMATIONS = _env_int("TRADING_TECHNICAL_MIN_CONFIRMATIONS", 2)
TECHNICAL_MIN_CONFLUENCE_SCORE = _env_float("TRADING_TECHNICAL_MIN_CONFLUENCE_SCORE", 1.30)
TECHNICAL_MIN_SIGNAL_SCORE = _env_float("TRADING_TECHNICAL_MIN_SIGNAL_SCORE", 0.45)
TECHNICAL_CONFLICT_VETO_SCORE = _env_float("TRADING_TECHNICAL_CONFLICT_VETO_SCORE", 1.30)
...
ALLOW_OPPOSITE_HEDGE = _env_bool("TRADING_ALLOW_OPPOSITE_HEDGE", False)
CONTROLLED_REVERSAL_ENABLED = _env_bool("TRADING_CONTROLLED_REVERSAL_ENABLED", True)
REVERSAL_MIN_CONFLUENCE = _env_int("TRADING_REVERSAL_MIN_CONFLUENCE", 2)
REVERSAL_MIN_ENTRY_SCORE = _env_float("TRADING_REVERSAL_MIN_ENTRY_SCORE", 0.65)
REVERSAL_SCORE_EDGE = _env_float("TRADING_REVERSAL_SCORE_EDGE", 0.10)
REVERSAL_MIN_POSITION_AGE_SECONDS = _env_int("TRADING_REVERSAL_MIN_POSITION_AGE_SECONDS", 60)
REVERSAL_MAX_ADVERSE_R = _env_float("TRADING_REVERSAL_MAX_ADVERSE_R", 0.75)
...
BLOCK_A_ONLY_SELL = _env_bool("TRADING_BLOCK_A_ONLY_SELL", True)
STRUCTURAL_STOP_ENABLED = _env_bool("TRADING_STRUCTURAL_STOP_ENABLED", True)
STRUCTURAL_STOP_LOOKBACK_BARS = _env_int("TRADING_STRUCTURAL_STOP_LOOKBACK_BARS", 30)
STRUCTURAL_STOP_BUFFER_ATR = _env_float("TRADING_STRUCTURAL_STOP_BUFFER_ATR", 0.15)
STRUCTURAL_STOP_SPREAD_MULTIPLIER = _env_float("TRADING_STRUCTURAL_STOP_SPREAD_MULTIPLIER", 1.50)
STRUCTURAL_STOP_MAX_ATR = _env_float("TRADING_STRUCTURAL_STOP_MAX_ATR", 1.80)
STRUCTURAL_STOP_MIN_REWARD_RISK = _env_float("TRADING_STRUCTURAL_STOP_MIN_REWARD_RISK", 1.30)
...
HISTORICAL_SIGNAL_DATASET_FILE = _data_file("historical_signal_dataset.csv")
...
AI_MIN_TRAINING_SAMPLES = _env_int("TRADING_AI_MIN_TRAINING_SAMPLES", 200)
AI_MIN_TEST_SAMPLES = _env_int("TRADING_AI_MIN_TEST_SAMPLES", 40)
AI_REPLAY_MAX_M1_BARS = _env_int("TRADING_AI_REPLAY_MAX_M1_BARS", 20000)
AI_REPLAY_OUTCOME_HORIZON_BARS = _env_int("TRADING_AI_REPLAY_OUTCOME_HORIZON_BARS", 240)
AI_REPLAY_MIN_SIGNAL_SPACING_BARS = _env_int("TRADING_AI_REPLAY_MIN_SIGNAL_SPACING_BARS", 3)
AI_REPLAY_SCAN_STEP_BARS = _env_int("TRADING_AI_REPLAY_SCAN_STEP_BARS", 30)
AI_MAX_SHADOW_TO_REAL_RATIO = _env_float("TRADING_AI_MAX_SHADOW_TO_REAL_RATIO", 2.0)
...
STOP_REVIEW_LOG_FILE = _data_file("stop_review_log.csv")
STOP_REVIEW_HORIZON_BARS = _env_int("TRADING_STOP_REVIEW_HORIZON_BARS", 30)
